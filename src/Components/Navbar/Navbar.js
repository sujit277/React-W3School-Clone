...
const Navbar = () => {
            ...
            return (
                <>
                    <div className="nav-item navitemsbuttons">
                        <button type="button" className="btn btn-success btncst" onClick={login}><strong>{localStorage.getItem("UserName")}</strong></button>
                    </div>
                    <div className="nav-item navitemsbuttons">
                        <button type="button" className="btn btn-light btncst course" onClick={logOut}><strong>Logout</strong></button>
                    </div>
                </>);
        }
        else {
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-light" style={{ padding: "0px 0px" }}>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item navitems">
                                <button className="nav-link box31" onClick={showNav} ><strong>Tutorials</strong></button>
                            </li>
                            <li className="nav-item navitems">
                                <a className="nav-link" href="/"><strong>References</strong></a>
                            </li>
                            <li className="nav-item navitems">
                                <a className="nav-link" href="/"><strong>Excercise</strong></a>
                            </li>
                        </ul>
                        <div className="nav-item navitemsbuttons">
                            <button type="button" className="btn btn-light btncst course"><strong>Paid Courses</strong></button>
                        </div>
                        {check()}
                        {/* <div className="nav-item navitemsbuttons">
                            <button type="button" className="btn btn-success btncst" onClick={login}><strong>Login</strong></button>
            ...
            {visible ?
                <div className="row" style={{ backgroundColor: "#282A35", display: visible }}>
                    <div className="col-sm-3" style={{ height: "auto" }}>
                        <div className="mt-5" style={{ paddingLeft: "50px" }}>
                            <h3 style={{ color: "#FFF4A3" }}>HTML and CSS</h3>
                            <a href="/content"><h5 className="box32">Learn HTML</h5></a>
                            <a href="/content"><h5 className="box32">Learn CSS</h5></a>
